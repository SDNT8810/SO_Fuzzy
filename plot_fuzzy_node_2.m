...
title('Input weighting representation based on robot heading', 'FontSize', 24, 'FontWeight', 'bold', 'FontName', 'Times New Roman', 'Color', 'black');
...
hLegend = legend([GoalDir, Inputs, Weighting, reference_circle], {'Robot heading', 'Inputs', 'Weight', 'Reference circle'}, 'FontSize', 24, 'Location', 'best');
