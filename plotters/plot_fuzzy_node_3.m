...
i = 1;
center_angle = Robot_Heading; % Center of the Gaussian filter
...
center_gaussian = Robot_Heading; % Center of the Gaussian
...
for i = 1:num_intervals
    ...
    Node_3_Output(i) = MF_Lid_(i) * mean(gaussian_shape(x_values >= x_start & x_values <= x_end));
end
